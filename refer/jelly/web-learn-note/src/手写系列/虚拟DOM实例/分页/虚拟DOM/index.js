...
const html = e(
	...
	e(
		...
		e(
			...
			e(
				...
				e(
					...
					' \u672C\u6587\u5B9E\u73B0\u4E86\u4E00\u4E2A\u7B26\u5408Promises/A+ \u89C4\u8303\u7684 Promise\uFF0C\u6211\u4EEC\u53EF\u4EE5\u7EE7\u7EED\u81EA\u5DF1\u52A8\u624B\uFF0C\u53C2\u8003 ES6 \u7684 Promise \u65B9\u6CD5\u5BF9 MyPromise \u8FDB\u884C\u62D3\u5C55\u7EC3\u4E60\u3002 '
				)
			),
			e(
				'ul',
		...
		e('img', {
			...
			class: 'lazy thumb',
			'data-src':
				'https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/596c26911f3342ea86adcc94c441332d~tplv-k3u1fbpfcp-zoom-mark-crop-v2:0:0:360:240.awebp',
		})
	)
)
...
class LikeButton extends React.Component {
	...
	render() {
		...
		return e(
			'div',
			null,
			e('p', null, '分页消耗时长：', e('span', null, time), 'ms'),
			e(
				'div',
				null,
			...
			e(
				...
				data.map((dataItem, index) => {
					...
					return e('li', { key }, [`${index}-${dataItem}`, html])
				})
			)
		)
	}
