...
export function getHook(): TUseStateHookStructData | undefined {
	const alternate: TFiberNode | null = __RUNTIME_COMPT_PROFILE___.workInProgressFiberOfNowCompt?.alternate as TFiberNode
	if (!alternate) {
		return
	}
